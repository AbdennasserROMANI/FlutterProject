...
class kategorilerL{
  int kid;//Kategorinin id
  String isim;//Kategorinin ismi
  String resim;//Kategorinin fotografi
  List<sarkicilarL> sarkici;//Kategorinin sarkicilari
  kategorilerL({required this.kid,required this.isim,required this.sarkici,required this.resim});//Veri Eklemek icin
}
